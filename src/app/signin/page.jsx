            ...
            <>              
              ...
              <form onSubmit={handleSignIn}>
                ...
                <CardFooter className="block">
                  ...
                  <div className="mt-6">
                    <p className="flex items-center justify-center gap-2 text-[#001238] font-semibold text-sm">Don’t have an account? <Link href="/signup" className="block text-[#2c5ef9] font-bold text-sm" >Sign Up</Link></p>
                  </div>
                </CardFooter>
              </form>
            </>

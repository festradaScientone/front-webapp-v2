...
const Editor = dynamic(() => import("@/components/dashboard/knowledge/Editor"), {
  ssr: false,
});
...
export default async function Page() {
  ...
  return (
    <>
      <div className="w-full min-h-[95%] bg-white rounded-md mb-4 border border-black/5 shadow-[0px_0px_10px_0px_rgba(0,0,0,0.05)]">
